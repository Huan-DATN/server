/**
 * Updated by effiwork.com's author on Oct 8 2023
 * effiwork.com
 * "A bit of fragrance clings to the hand that gives flowers!"
 */

export const UUID_V4_MESSAGE = "Your string fails to match the UUID pattern!";
...
export const EMAIL_RULE_MESSAGE = "Email is invalid. (example@effiwork.com)";
